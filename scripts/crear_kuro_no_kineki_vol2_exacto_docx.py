            ...
            "escenas": [
                {
                    ...
                    "texto": """El aire en la plaza del palacio se volvió insoportable. Kael, movido por la energía de la Emperatriz, se desplazó a una velocidad que superaba la barrera del sonido. La Daga Solar cortó el aire dejando un rastro de fuego blanco que derritió las columnas de mármol a su paso.
...
Sora apareció desde la sombra de una columna destruida, lanzando tres agujas de tinta congelada directo a las articulaciones de Kael para inmovilizarlo sin matarlo.""",
                ...
                },
                {
                    ...
                    "texto": """Kael bloqueó las agujas de Sora con el lomo de su hoja dorada, pero el movimiento lo dejó expuesto por una fracción de segundo. Kael aprovechó la brecha para cerrar la distancia, pero en lugar de atacar con el filo de su arma, cerró la daga y golpeó el pecho de Kael con la mano izquierda abierta.
...
Pero en el centro de la plataforma, el lugar donde estaba Kael quedó sumido en un silencio sepulcral.""",
                ...
                },
                {
                    ...
                    "texto": """Sora y Kael corrieron hacia el centro de la plaza destruida.
