...
"""
===============================================================================
HOTMART AUTOMATED UPLOADER VIA ACTIVE BRAVE CDP SESSION
===============================================================================
"""
...
async def main():
    async with async_playwright() as p:
        print("Conectando a la sesión activa de Brave en http://localhost:9222...")
        try:
            browser = await p.chromium.connect_over_cdp("http://localhost:9222")
        except Exception as e:
            print("ERROR: No se pudo conectar a Brave en el puerto 9222.", e)
            return
        ...
        for book in LIBROS:
            try:
                ...
                print(f" [!] Error al procesar {book}: {e}")

        print(f"\n=======================================================")
        print(f" PROCESO COMPLETADO: {exitosos}/{len(LIBROS)} libros subidos a Hotmart")
        print(f"=======================================================\n")
