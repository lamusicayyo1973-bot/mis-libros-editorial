...
"""
===============================================================================
PUBLICADOR DEFINITIVO INDEPENDIENTE EN HOTMART (15 LIBROS)
===============================================================================
Abre una pestaña limpia por cada libro para evitar destrucción de contexto,
completa los 4 pasos y confirma la creación.
===============================================================================
"""
...
async def publicar_libro_pestana_limpia(context, folder_name, index, total):
    ...
    print(f"\n========================================================")
    print(f" [{index:02d}/{total:02d}] HOTMART DEFINITIVO: {titulo}")
    print(f"========================================================")
    ...
    try:
        ...
        if price_input:
            try:
                await price_input.fill(f"{precio}.00")
            except Exception:
                pass
        ...
        print(f"   🎉 ¡EXITO! {titulo} procesado completamente en Hotmart.")
        await page.close()
        return True

    except Exception as e:
        print(f"   [!] Aviso procesando {folder_name}: {e}")
        try:
            await page.close()
        except Exception:
            pass
...
async def main():
    print("======================================================================")
    print("   PUBLICACIÓN DEFINITIVA INDEPENDIENTE EN HOTMART (15 LIBROS)")
    print("======================================================================")
    ...
    async with async_playwright() as p:
        ...
        for idx, folder_name in enumerate(LIBROS_ORDENADOS, 1):
            res = await publicar_libro_pestana_limpia(context, folder_name, idx, total)
            if res:
                exitos += 1
