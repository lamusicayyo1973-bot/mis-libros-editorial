...
def create_oni_vol3_docx():
    ...
    chapters_toc = [
        ...
        ("Capítulo 3", "La Llegada del Tercer Lunar", "chap3"),
    ...
    content = [
        {
            ...
            "scenes": [
                {
                    "num": "Escena 1: El Despertar del Pilar",
...
Los dos ataques impactaron el núcleo de carne de la caldera exactamente al mismo tiempo. La combinación del calor del fuego y la velocidad de la electricidad destrozó la estructura de masa demoníaca sin darle tiempo a regenerarse."""
                },
                {
                    ...
                    "text": """El grito agudo del Sexto Lunar Rojo resonó en toda la montaña mientras la masa orgánica del tren comenzaba a disolverse en cenizas.
...
El vapor se dispersó sobre el campo bajo la luz del amanecer. El peligro parecía haber pasado."""
        ...
        },
        {
            "id": "chap3",
            "number": "Capítulo 3",
            "title": "La Llegada del Tercer Lunar",
            "scenes": [
                {
...
—Una técnica de fuego bastante pulida... —dijo el Tercer Lunar, mirando a Kenshin con una sonrisa llena de anticipación—. Hacía más de cincuenta años que no encontraba a un Pilar de la Respiración del Fuego."""
                },
                {
                    ...
                    "text": """Kenshin dio un paso al frente, interponiéndose entre el Tercer Lunar y los jóvenes heridos. Aunque estaba agotado por mantener a salvo a los pasajeros, su postura con la katana de fuego era impecable.
...
—Envejecer y morir es lo que le da valor y belleza a la vida humana. Precisamente porque somos efímeros, nuestro esfuerzo es sagrado. No me convertiré en un monstruo."""
                },
                {
                    ...
                    "text": """Sin decir una palabra más, Akaza se lanzó al ataque.
            ...
            "scenes": [
                {
                    ...
                    "text": """A pesar de la maestría de Kenshin, la regeneración del Tercer Lunar era instantánea. Cada corte hecho por la katana de fuego se cerraba en milisegundos, mientras que las heridas en el cuerpo de Kenshin comenzaban a acumularse.
...
Kenshin inhaló una cantidad monumental de aire, haciendo crujir sus pulmones mientras el fuego de su espada se volvía de un color blanco incandescente."""
                },
                {
                    ...
                    "text": """—Respiración del Fuego... Novena Postura: Purgatorio.
...
En el horizonte, los primeros rayos del sol matutino comenzaron a asomar sobre la cumbre de las montañas."""
                },
                {
                    ...
                    "text": """Al sentir el calor del primer rayo de sol sobre su piel, Akaza entró en pánico absoluto. La piel de sus hombros comenzó a quemarse y desintegrarse en cenizas.
...
—¡Cobarde! —gritó Ren con lágrimas en los ojos, corriendo hacia el bosque—. ¡No huyas! ¡El señor Kenshin no huyó! ¡Él ganó esta batalla porque protegía a los demás! ¡Tú solo eres una bestia miedosa que le teme al sol!"""
        ...
        },
        {
            ...
            "scenes": [
                {
                    "num": "Escena 1: Las Últimas Palabras del Pilar",
...
En el cementerio del Gremio Cuervo, las cuervos mensajeros llevaron la noticia de la caída del Pilar del Fuego a todos los rincones del país. Los restantes ocho Pilares recibieron el mensaje en silencio, apretando sus armas con una nueva determinación.
...
ficha_data = {
    ...
    "headline": "La batalla en el Tren Demoníaco. El choque del Pilar del Fuego contra el Tercer Lunar. Y el legado sagrado de la Respiración del Sol.",
    "descripcion": "El Tren de las Sombras se ha convertido en una masa viva de carne demoníaca. Ren, Miyuki y el joven del haori de rayos combinan sus estilos para cortar el núcleo de la caldera, pero tras el descarrilamiento, el aterrador Akaza —Tercer Lunar Rojo— emerge del bosque. Kenshin, el Pilar del Fuego, desata su Novena Postura Purgatorio en una batalla legendaria hasta las últimas consecuencias bajo los primeros rayos del sol.",
    "beneficios": [
    ...
    "capitulos": [
        ...
        "Capítulo 3: La Llegada del Tercer Lunar",
    ...
    <div class="container">
        <div class="product-grid">
            ...
            <div>
                ...
                <p>La batalla en el Tren Demoníaco. El choque del Pilar del Fuego contra el Tercer Lunar. Y el legado sagrado de la Respiración del Sol.</p>
                <p>El Tren de las Sombras se ha convertido en una masa viva de carne demoníaca. Ren, Miyuki y el joven del haori de rayos combinan sus estilos para cortar el núcleo de la caldera, pero tras el descarrilamiento, el aterrador Akaza —Tercer Lunar Rojo— emerge del bosque.</p>
        ...
        <div class="chapters-list">
            <ul>
                ...
                <li><strong>Capítulo 3:</strong> La Llegada del Tercer Lunar (Escenas 1-3)</li>
        ...
        <div class="gallery-grid">
            <img src="escena_1.jpg" alt="La Respiración del Trueno en el Tren">
