...
"""
===============================================================================
PUBLICACIÓN DIRECTA CON SESIÓN RECIÉN LOGUEADA EN HOTMART
===============================================================================
Conecta a la pestaña activa donde el usuario acaba de iniciar sesión
y sube los libros paso a paso.
===============================================================================
"""
...
async def publicar_libro(page, folder_name, idx, total):
    ...
    try:
        ...
        name_in = await page.wait_for_selector('#name, input[name="name"]', timeout=8000)
        ...
        cat_btn = await page.query_selector('button:has-text("Literatura"), button:has-text("Negocios y Carrera"), button:has-text("Educacional")')
        if cat_btn:
...
async def main():
    print("======================================================================")
    print("   PUBLICACIÓN EN SESIÓN RECIÉN LOGUEADA EN HOTMART")
    print("======================================================================")
    ...
    async with async_playwright() as p:
        ...
        page = hotmart_pages[0] if hotmart_pages else context.pages[0]

        total = len(LIBROS_NUEVOS)
        exitos = 0

        for idx, folder_name in enumerate(LIBROS_NUEVOS, 1):
        ...
        print("\n" + "=" * 70)
        print(f"   RESULTADO FINAL: {exitos}/{total} LIBROS SUBIDOS Y PROCESADOS")
        print("=" * 70)
