...
""")
        ...
        ("Capítulo 3: La Batalla de la Tinta de Plata", [
            ("Escena 1: El Poder del Escriba", """
El combate en la torre se volvió un caos de energía. Los Devoradores de Ecos se movían con una coordinación perfecta, atacando en ráfagas que desgastaban la defensa de Ren y Sora.
