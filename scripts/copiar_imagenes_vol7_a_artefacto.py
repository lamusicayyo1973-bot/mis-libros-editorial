...
images = [
    ...
    ("escena_c1_e1.jpg", "Capítulo 1 - Escena 1: Aoi la Hashira Mariposa en vigas flotantes"),
    ...
    ("escena_c3_e1.jpg", "Capítulo 3 - Escena 1: Genba el Pilar de la Piedra y Kazuma el Pilar del Viento"),
